package com.jac.estatusbar.statusbar;
...
public class StatusBarUtil {
     ...
     */
    public static void setStutatusBar(Activity activity, boolean isPadding, boolean isTextColor, int colorId) {
        //当FitsSystemWindows设置 true 时，会在屏幕最上方预留出状态栏高度的 padding
        StatusBarUtil.setRootViewFitsSystemWindows(activity, isPadding);
        //设置状态栏字体颜色深浅
        StatusBarUtil.setStatusBarDarkTheme(activity, isTextColor);
        //设置状态栏背景颜色
        if (colorId == 1) {
     ...
     */
    public static void setImageStutatusBar(Activity activity, boolean isTextColor) {
        //当FitsSystemWindows设置 true 时，会在屏幕最上方预留出状态栏高度的 padding
